"""
Unit tests for SearchBotAgent
"""

import pytest
from agent import SearchBotAgent
...
def test_agent_initialization(agent):
    ...
    assert agent.name == "search-bot"
    assert agent.model is not None
    assert agent.description == "Performs web searches and returns summaries"
