---
name: trigger-config
description: Configure your Trigger.dev project with `trigger.config.ts` and build extensions. Use when setting up a new project or adding advanced database/browser/media support.
---
