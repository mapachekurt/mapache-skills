---
name: trigger-agents
description: Build production-ready AI agents using Trigger.dev's durable execution. Use when creating prompt chains, parallel LLM workflows, or human-in-the-loop AI systems.
---
